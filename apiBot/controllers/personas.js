...
const { handleResponseJsonMsg, handleResponseJson } = require('../utils/handleResponseJson');

const { uploadMiddleware, deleteFile } = require("../utils/handleStorage");
        ...
        upload(req, res, async function (err) {
            ...
            try {
                ...
                try {
                    ...
                    console.log("Error al crear usuario:", dbError.message);
                    handleHttpError(res, "ERROR_CREAR_USUARIO", 500);
                }
